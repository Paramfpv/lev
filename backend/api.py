...
from backend.supabase_utils import supabase

# 1️⃣ Create FastAPI instance
app = FastAPI(title="LEV Longevity RAG API", version="1.0")

# 2️⃣ Initialize chatbot once (stays in memory)
...
# 7️⃣ Main chat route (saves chat history to Supabase)
@app.post("/chat")
...
# 8️⃣ Get chat history for a user
